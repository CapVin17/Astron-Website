                ...
                <SheetContent className="bg-transparent backdrop-blur-[8px]">
                    <SheetHeader>
                        <SheetDescription className="pt-20 px-10 flex flex-col gap-4">
                            ...
                            <Link onClick={handleLinkClick} href="/tools"><Button className="w-full items-center justify-start text-lg flex backdrop-blur-lg bg-clip-padding backdrop-filter uppercase text-[#9ac34d]" variant="outline ">Tools</Button></Link>
