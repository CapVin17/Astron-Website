    ...
    return(
        <>
            <div className="fixed -z-50">
                <Image className="h-screen w-screen opacity-30" src={bg}/>
            </div>
            <div className="h-full pt-32 pb-20 pl-10 lg:pl-40">
                ...
                <div className="py-5 lg:py-10">
                    <Button size="lg" className="hidden lg:block xl:block 2xl:block text-white text-base active:scale-75 transform duration-400">Book a free consultation</Button>
                    <Button size="sm" className="lg:hidden xl:hidden 2xl:hidden text-white text-xs active:scale-75 transform duration-400">Book a free consultation</Button>
                </div>
            </div>
        </>
    )
