            ...
            <div className="h-full bg-white py-20 px-10 lg:px-72">
                ...
                <div className="flex flex-wrap-reverse items-center justify-center md:py-10 lg:py-10 xl:py-10 2xl:py-10">
                    <div className="w-full h-full md:w-1/2 lg:w-1/2 xl:w-1/2 2xl:w-1/2 flex flex-col items-start justify-center gap-5 pt-5">
                        ...
                        <Input type="text" color="secondary" label="Name" variant="bordered" className="text-[#38434d]" />
                        <Input type="email" color="secondary" label="Email *" variant="bordered" className="text-[#38434d]" required />
                        <Textarea type="text" color="secondary" label="Message *" variant="bordered" className="text-[#38434d]" required />
